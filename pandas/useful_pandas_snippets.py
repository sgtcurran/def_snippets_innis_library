...
# that works well in terminal or Jupyter cell, for more thorough summarizing, and also see `df.info()` below
...
# Looking into `.assign` more, it looks like it has the awesome feature that you can use it to add columns with contents based on 
...
# Alternatively for resticting to columns, you can use a dictionary with the columns as keys:
...
#matter that xlrd doesn't suppoer `.xlsx` as of the start of 2021, see https://stackoverflow.com/a/65266270/8508004
